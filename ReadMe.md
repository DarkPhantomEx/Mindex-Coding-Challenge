...
not be persisted.
-----
REST Endpoint created at /api/employee/reportingStructure
...
-----
REST Endpoint Created at /api/compensation
REST Endpoint Created at /api/compensation/employee/{id}
